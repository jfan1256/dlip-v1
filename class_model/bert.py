...
class BertModel(BertPreTrainedModel):
    ...
    def __init__(self, config, add_pooling_layer=True, add_cross_attention=True, encoder_width=None):
        super().__init__(config)
        self.config = config
        if encoder_width:
            self.config.encoder_width = encoder_width
        self.config.add_cross_attention = add_cross_attention
